  ...
  return (
    <>
      <button
        onClick={handleClick}
        type="button"
        title="Instalar terminal como aplicación de escritorio / móvil"
        className={`flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl font-bold text-xs md:text-sm shadow-md hover:shadow-lg transition-all duration-150 active:scale-95 cursor-pointer border border-blue-400/30 ${className}`}
      >
        ...
        <div className="fixed inset-0 bg-slate-900/70 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl relative border border-slate-100 text-slate-800">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-black text-slate-900 leading-tight">Instalar Aplicación</h3>
            ...
            <div className="flex bg-slate-100 p-1 rounded-xl mb-4 text-xs font-semibold">
              <button
                ...
                className={`flex-1 py-1.5 rounded-lg transition-all ${
                  activeTab === 'desktop' ? 'bg-white text-blue-700 shadow-xs' : 'text-slate-600 hover:text-slate-900'
                }`}
              >
                💻 Chrome / Edge
              </button>
              <button
                ...
                className={`flex-1 py-1.5 rounded-lg transition-all ${
                  activeTab === 'mac' ? 'bg-white text-blue-700 shadow-xs' : 'text-slate-600 hover:text-slate-900'
                }`}
              >
                🍏 Safari Mac
              </button>
              ...
              {activeTab === 'desktop' && (
                <div className="space-y-2.5">
                  <div className="flex items-start gap-2.5">
                    <span className="w-5 h-5 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">1</span>
                    <p className="text-xs text-slate-700 leading-relaxed">
                      En la <strong>barra de direcciones (URL)</strong> de Chrome o Edge, busca el icono de instalación <span className="material-symbols-outlined inline text-sm align-middle text-blue-600 font-bold">download</span> o <span className="material-symbols-outlined inline text-sm align-middle text-blue-600 font-bold">install_desktop</span> a la derecha.
                    </p>
                  </div>
                  <div className="flex items-start gap-2.5">
                    <span className="w-5 h-5 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">2</span>
                    <p className="text-xs text-slate-700 leading-relaxed">
                      O haz clic en el menú <strong>⋮ (Opciones)</strong> de tu navegador &gt; <strong>"Instalar App"</strong> o <strong>"Guardar y compartir &gt; Instalar página como app"</strong>.
                    </p>
                  </div>
                  <div className="flex items-start gap-2.5">
                    <span className="w-5 h-5 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">3</span>
                    <p className="text-xs text-slate-700 leading-relaxed">
              ...
              {activeTab === 'ios' && (
                <div className="space-y-2.5">
                  <div className="flex items-start gap-2.5">
                    <span className="w-5 h-5 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">1</span>
                    <p className="text-xs text-slate-700 leading-relaxed">
                      Toca el botón <strong>Compartir</strong> (icono <span className="material-symbols-outlined inline text-sm align-middle text-blue-600 font-bold">ios_share</span> en la barra de Safari).
                    </p>
                  </div>
                  <div className="flex items-start gap-2.5">
                    <span className="w-5 h-5 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">2</span>
            ...
            <div className="flex gap-2">
              {isInstallable && (
                <button
                  ...
                  className="flex-1 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm rounded-xl transition-colors shadow-sm flex items-center justify-center gap-1.5"
                >
